...
def search(q):
    # simpler query without complex +
    url = f"http://export.arxiv.org/api/query?search_query=all:{urllib.parse.quote(q)}&start=0&max_results=3&sortBy=submittedDate&sortOrder=desc"
    try:
