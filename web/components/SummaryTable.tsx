        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-4 py-2.5 text-left text-xs font-semibold
                text-gray-500 uppercase w-24">Fasa</th>
              {trafos.map(t => (
                <th key={t.config.name}
          ...
          <tbody>
            ...
            <tr className="border-t-2 border-gray-200 bg-gray-50">
              ...
              {trafos.map(t => (
                <td key={t.config.name}
                  className="px-4 py-3 text-center font-mono font-bold text-gray-900">
